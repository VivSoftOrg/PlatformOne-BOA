...
from exposed_security_groups.exposed_security_groups_constants import Constants
from utility.port_utility import PortUtility


class ExposedSecurityGroupsAction(AbstractAction):
    ...
    def __revokePublicRule(self, eventItem, ec2Client):
        ...
        try:
            excludedPorts = self._AbstractAction__eventParam.configParam['excludedPorts']
            ...
            groupID = eventItem.configItems.get("groupid")
