...
import sys
import os
import check_rds_required_tag_values.check_rds_required_tag_values_action as rdsAction
...
EVENT_JSON = {
    ...
    "ruleParameters": "{\n  \"toEmail\": \"ankush.tehele@reancloud.com\", \"validity\": \"1\",\n  \"performAction\": \"True\",\n  \"notifier\": \"ses\", \"RequiredTags\": \"Owner, Environment, Project, ExpirationDate\"  \n}",
    "resultToken": " ",
...
__validityExpired = [ { "Key": "RequiredTagsExpirationDate", "Value": "2018-01-02"} ]
...
class TestRDSRequiredTagAction(object):
    __regions = ['us-east-1']
    ...
    checkRdsRequiredAction = rdsAction.CheckRDSRequiredTagValuesAction(__eventParam)
    ...
    def testMultiAZRdsAction(self):
        ...
        result = self.checkRdsRequiredAction.performAction(eventItem)
        assert result == True
