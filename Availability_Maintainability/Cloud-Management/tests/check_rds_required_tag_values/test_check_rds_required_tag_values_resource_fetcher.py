...
import pytest
import boto3
import check_rds_required_tag_values.check_rds_required_tag_values_resource_fetcher as requiredTagFetcher
...
EVENT_JSON = {
    ...
    "ruleParameters": "{\n  \"toEmail\": \"ankush.tehele@reancloud.com\", \"forbiddenPorts\": \"22\",\n  \"performAction\": \"True\",\n  \"notifier\": \"ses\", \"validity\":\"3\", \"RequiredTags\":\"Owner, Project, Environment, ExpirationDate\" \n}",
...
class TestRequiredTagFetcher(object):
    ...
    },
    {
        "dbinstances": [{
            ...
            "dbinstancestatus": "stopped",
            "dbinstancearn": "arn:aws:rds:us-west-2:107339370656:db:mnc-543",
            "TagList" : [ {"Key" : "Owner","Value": "ankush.tehele" },{"Key" : "Project","Value": "Managed Cloud" },{"Key" : "Environment","Value": "test" },{"Key" : "ExpirationDate","Value": "2018-01-20" }]
        }]
    }
    ]
    ...
    __checkRDSResourceFetcher = requiredTagFetcher.CheckRDSRequiredTagValuesResourceFetcher(__eventParam) 
    ...
    def testResourceFetcher(self):
        ...
        requiredTagFetcher.BotoUtility.getClient = MagicMock(return_value=rdsClient)
        rdsClient.describe_db_instances = MagicMock(return_value=self.__mockResponse[0])
        return_value = self.__checkRDSResourceFetcher.resourceFetcher()
