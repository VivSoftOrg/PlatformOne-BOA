...
from check_iam_mfa.check_iam_mfa_resource_fetcher import *
from common.framework_objects import EvaluationResult
from common.compliance_object_factory import ComplianceObjectFactory
import check_iam_mfa.check_iam_mfa_resource_fetcher as mfa
...
USERS = {
    "Users": [{
        ...
        "UserId": "AIDAJNL63BJPIG4KUSNEC",
        "Path": "/",
        "CreateDate": (datetime.datetime.now() - relativedelta(days=3)),
        "Arn": "arn:aws:iam::107339370656:user/test.user",
    }],
    "ResponseMetadata": {
...
class TestCheckIamMfaFetcher(object):
    ...
    def test_fetcher_empty_list(self):
        ...
        mfa.BotoUtility.getClient = MagicMock(return_value=iamClient)

        usersList = mfa.IamMfaFetcher.resourceFetcher(self)
    ...
    def test_fetcher(self):
        ...
        self._IamMfaFetcher__parseAndFetchUserDetails = MagicMock(return_value=eventItems)
        usersList = mfa.IamMfaFetcher.resourceFetcher(self)
    ...
    def test_fetcher_exception(self):
        ...
        self._AbstractResourceFetcher__eventParam = eventParam
        mfa.BotoUtility.getClient = MagicMock(return_value=ClientError({'Error': {'Code':400}}, "boto"))
        configItems = {}
        configItems.update({'username':"test.user"})
        eventItems = ComplianceObjectFactory.createAWSConfigEventItemfrom(resourceId="AIDAJNL63BJPIG4KUSNEC", resourceType="AWS::IAM::User", configItems=configItems)
        self._IamMfaFetcher__parseAndFetchUserDetails = MagicMock(return_value=eventItems)
