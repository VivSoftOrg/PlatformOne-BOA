...
import copy_ec2_tags_to_ebs.copy_ec2_tags_to_ebs_resource_fetcher as resourceFetcher
...
class TestCopyEc2TagsToEbsResourceFetcher(object):
    ...
    def testResourceFetcher(self):
        ...
        resourceFetcher.CopyEc2TagsToEbsResourceFetcher.resourceFetcher(self)
    ...
    def testResourceFetcherFailure(self):
        ...
        return_value = resourceFetcher.CopyEc2TagsToEbsResourceFetcher.resourceFetcher(self)
