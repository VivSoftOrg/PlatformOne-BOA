...
import delete_unused_security_group.delete_unused_security_group_resource_fetcher as sgFetcher
...
class TestUnusedSGFetcher(object):
    ...
    __deleteUnusedSGFetcher = sgFetcher.DeleteUnusedSGResourceFetcher(__eventParam)
