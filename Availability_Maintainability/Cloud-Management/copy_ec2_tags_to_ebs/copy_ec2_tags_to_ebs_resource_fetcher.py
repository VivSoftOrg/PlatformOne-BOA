...
class CopyEc2TagsToEbsResourceFetcher(AbstractResourceFetcher):
    ...
    def __parseAndFetchInstanceDetails(self, instanceObject):
        ...
        resourceId = instanceObject[Constants.EC2_INSTANCE_ID]
        ...
        try:
            for region in regions:
                ...
                for response in paginatorResponse.paginate():
                    ...
                    instanceReservations = instanceResponse[Constants.RESPONSE_RESERVATIONS_REFERENCE]
                    for reservation in instanceReservations:
                        instanceObject = reservation[Constants.EC2_INSTANCES_REFERENCE][0]
