...
import detach_iam_policy.detach_iam_policy_evaluate as detachIAM
...
CONFIG_ITEMS = {"username": "anish.bhagwat", "userid": ""}
...
class TestDetachIamPolicyEvaluate(object):       
    ...
    __detachIam = detachIAM.DetachIamPolicyEvaluate(__eventParam)
    ...
    def test_evaluate_success(self):
        ...
        self.__isInlinePolicies = MagicMock(return_value=inlinePolicies)
        self.__isAttachedManagedPolicies = MagicMock(return_value=managedPolicies)        
        ...
        return_value = self.__detachIam.evaluate(eventItem)
    ...
    def test_evaluate_non_compliant(self):
        ...
        detachIAM.DetachIamPolicyEvaluate.isInlinePolicies = MagicMock(return_value=responseInlinePolicies)
        detachIAM.DetachIamPolicyEvaluate.isAttachedManagedPolicies = MagicMock(return_value=responsePolicies)        
        eventItem = ComplianceObjectFactory.createAWSConfigEventItemfrom(resourceId=RESOURCE_ID, resourceType=RESOURCE_TYPE, configItems=CONFIG_ITEMS)        
