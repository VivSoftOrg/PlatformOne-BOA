...
class PlaceboMockResponseInitializer():
    ...
    def getActionMock(mockType):
        ...
        PLACEBO_ACTION_MOCKS = 'test_copy_ec2_tags_to_ebs_action'
    ...
    def getEvaluatorMock(mockType):
        PLACEBO_DIR = 'placebo_recorded_responses'
        PLACEBO_EVALUATION_MOCKS = 'test_copy_ec2_tags_to_ebs_evaluate'
        dir_path = os.path.dirname(os.path.realpath(__file__))
    ...
    def getResourceFetcherMock(mockType):
        PLACEBO_DIR = 'placebo_recorded_responses'
        PLACEBO_RESOURCE_FETCHER_MOCKS = 'test_copy_ec2_tags_to_ebs_resource_fetcher'
        dir_path = os.path.dirname(os.path.realpath(__file__))
