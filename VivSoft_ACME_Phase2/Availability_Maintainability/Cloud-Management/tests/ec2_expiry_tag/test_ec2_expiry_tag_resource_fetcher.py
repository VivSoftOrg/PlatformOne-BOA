...
import ec2_expiry_tag.ec2_expiry_tag_resource_fetcher as resource_fetcher
...
class TestEc2ExpiryTagAction(object):
    ...
    def test_resource_fetcher(self):
        ...
        resource_fetcher.BotoUtility.getClient = MagicMock(return_value=ec2)
        return_value = resource_fetcher.Ec2ExpiryTagFetcher.resourceFetcher(self)
    ...
    def test_resource_fetcher_with_exception(self):
        ...
        ec2 = boto3.client('ec2', 'us-east-1')
        resource_fetcher.BotoUtility.getClient = MagicMock(return_value=ec2)
        ec2.describe_instances = MagicMock(side_effect=Exception("Failed to fetch resource details"))
        return_value = resource_fetcher.Ec2ExpiryTagFetcher.resourceFetcher(self)
