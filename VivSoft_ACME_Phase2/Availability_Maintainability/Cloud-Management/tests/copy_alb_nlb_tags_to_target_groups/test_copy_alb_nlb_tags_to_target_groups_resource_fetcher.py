...
from copy_alb_nlb_tags_to_target_groups.copy_alb_nlb_tags_to_target_groups_resource_fetcher import *
...
class TestCopyAlbNlbTagsToTargetGroupsResourceFetcher(unittest.TestCase):
    __eventParam = complianceobjectfactory.ComplianceObjectFactory.createEventParamFrom(
        EVENT_JSON,
        CONTEXT
    )

    __albFetcher = CopyAlbNlbTagsToTargetGroupsResourceFetcher(__eventParam)
    ...
    def testALBLBResourceFetcherSuccess(self):
        ...
        return_value = self.__albFetcher.resourceFetcher()
